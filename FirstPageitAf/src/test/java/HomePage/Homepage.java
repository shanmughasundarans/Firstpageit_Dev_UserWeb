...
//	executor.executeScript("arguement[0].scrollIntoView(true)", Js);
	...
	public void FIPGTS_00002_FIPGTS_00001() throws InterruptedException {
		...
		String backcolor = driver.findElement(By.xpath("//a[contains(text(),'What is FP?')]"))
	...
	public void FIPGTS_00002_FIPGTS_00002() throws InterruptedException {
		...
		// KnowMore options
		String color = driver.findElement(By.xpath("//a[contains(text(),'Detailed Instructions')]"))
				.getCssValue("color");

		String backcolor = driver.findElement(By.xpath("//a[contains(text(),'Detailed Instructions')]"))
				.getCssValue("background-color");
	...
	public void FIPGTS_00002_FIPGTS_00003() throws InterruptedException {
		...
		String backcolor = driver.findElement(By.xpath("//a[contains(text(),'Videos')]"))
				.getCssValue("background-color");
	...
	public void FIPGTS_00002_FIPGTS_00004() throws InterruptedException {
		...
		String backcolor = driver.findElement(By.xpath("//a[contains(text(),'Become an RStar')]"))
				.getCssValue("background-color");
	...
	public void FIPGTS_00002_FIPGTS_00005() throws InterruptedException {
		...
		String backcolor = driver.findElement(By.xpath("//a[contains(text(),'TOS/Privacy Policy')]"))
				.getCssValue("background-color");
	...
	public void FIPGTS_00002_FIPGTS_00006() throws InterruptedException {
		...
		String backcolor = driver.findElement(By.xpath("//a[contains(text(),'Contact Us')]"))
				.getCssValue("background-color");
	...
	public void FIPGTS_00002_FIPGTS_00007() throws InterruptedException {
		...
		Actions act = new Actions(driver);
		WebElement FIPGTS_00002_FIPGTS_00007_contactusknowmore = driver
				.findElement(By.xpath("//a[contains(text(),'Know More')]"));
		...
		WebElement FIPGTS_00002_FIPGTS_00007_knowmore = driver
				.findElement(By.xpath("//*[contains(text(),'What is FP?')]"));
	...
	public void FIPGTS_00002_FIPGTS_00008() throws InterruptedException {
		...
		Actions act = new Actions(driver);
		WebElement FIPGTS_00002_FIPGTS_00008_knowmore = driver
				.findElement(By.xpath("//a[contains(text(),'Know More')]"));
		...
		WebElement FIPGTS_00002_FIPGTS_00008Detailedinstruction = driver
				.findElement(By.xpath("//a[contains(text(),'Detailed Instructions')]"));
	...
	public void FIPGTS_00002_FIPGTS_00009() throws InterruptedException {
		...
		Actions act = new Actions(driver);
		WebElement FIPGTS_00002_FIPGTS_00009_knowmore = driver
				.findElement(By.xpath("//a[contains(text(),'Know More')]"));
	...
	public void FIPGTS_00002_FIPGTS_000010() throws InterruptedException {
		...
		Actions act = new Actions(driver);
		WebElement FIPGTS_00002_FIPGTS_000010_knowmore = driver
				.findElement(By.xpath("//a[contains(text(),'Know More')]"));
		...
		WebElement FIPGTS_00002_FIPGTS_000010_BecomeRstar = driver
				.findElement(By.xpath("//a[contains(text(),'Become an RStar')]"));
	...
	public void FIPGTS_00002_FIPGTS_000011() throws InterruptedException {
		...
		Actions act = new Actions(driver);
		WebElement FIPGTS_00002_FIPGTS_000011_knowmore6 = driver
				.findElement(By.xpath("//a[contains(text(),'Know More')]"));
		...
		WebElement FIPGTS_00002_FIPGTS_000011_TOS = driver
				.findElement(By.xpath("//a[contains(text(),'TOS/Privacy Policy')]"));
	...
	public void FIPGTS_00002_FIPGTS_000012() throws InterruptedException {
		...
		Actions act = new Actions(driver);
		WebElement FIPGTS_00002_FIPGTS_000012_knowmore = driver
				.findElement(By.xpath("//a[contains(text(),'Know More')]"));
		...
		WebElement FIPGTS_00002_FIPGTS_000012_knowmore_Contactus = driver
				.findElement(By.xpath("//a[contains(text(),'Contact Us')]"));
	...
	public void FIPGTS_00003_FIPGTS_00001() throws InterruptedException {
		...
		Actions act = new Actions(driver);
		WebElement FIPGTS_00003_FIPGTS_00001_contactusknowmore = driver
				.findElement(By.xpath("//a[contains(text(),'Know More')]"));
		act.moveToElement(FIPGTS_00003_FIPGTS_00001_contactusknowmore).perform();
		Thread.sleep(2000);
		String FIPGTS_00002_FIPGTS_00007homeur = driver.getCurrentUrl();

		WebElement FIPGTS_00003_FIPGTS_00001_knowmore = driver
				.findElement(By.xpath("//*[contains(text(),'What is FP?')]"));
	...
	public void FIPGTS_00003_FIPGTS_00004() throws InterruptedException {
		...
		Boolean Display2 = driver.findElement(By.xpath("//*[contains(text(),'Detailed Instructions')]")).isDisplayed();
		System.out.println(
				"FIPGTS_00003_FIPGTS_00004_Knowmore_DetailedInstructionOption_Element displayed is :" + Display2);
...
//		driver.get("http://18.218.59.128/firstpage/public/Know_More#pitch");
		Actions act = new Actions(driver);
		Thread.sleep(2000);
		WebElement FIPGTS_00003_FIPGTS_00006_knowmore_WhatsFP = driver
				.findElement(By.xpath("//a[contains(text(),'Know More')]"));
		...
		WebElement FIPGTS_00003_FIPGTS_00006_knowmore_WhatsFP1 = driver
				.findElement(By.xpath("//*[contains(text(),'What is FP?')]"));
	...
	public void FIPGTS_00003_FIPGTS_00007() throws InterruptedException {
		...
		Actions act = new Actions(driver);
		WebElement FIPGTS_00003_FIPGTS_00007_knowmore = driver
				.findElement(By.xpath("//a[contains(text(),'Know More')]"));
		...
		WebElement FIPGTS_00003_FIPGTS_00007_Detailedinstruction = driver
				.findElement(By.xpath("//a[contains(text(),'Detailed Instructions')]"));
	...
	public void FIPGTS_00003_FIPGTS_00008() throws InterruptedException {
		...
		Actions act = new Actions(driver);
		WebElement FIPGTS_00003_FIPGTS_00008_knowmore = driver
				.findElement(By.xpath("//a[contains(text(),'Know More')]"));
	...
	public void FIPGTS_00003_FIPGTS_00009() throws InterruptedException {
		...
		Actions act = new Actions(driver);
		WebElement FIPGTS_00003_FIPGTS_00009_knowmore = driver
				.findElement(By.xpath("//a[contains(text(),'Know More')]"));
		...
		WebElement FIPGTS_00003_FIPGTS_00009_BecomeRstar = driver
				.findElement(By.xpath("//a[contains(text(),'Become an RStar')]"));
